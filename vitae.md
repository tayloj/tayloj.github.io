...
- Ph.D., Computer Science, January 2008--December 2014
  ...
  Dissertation: [Explorations in Fluid Logics][]
...
#### Graduate Research Assistant (Computer Science), 2008--2011

#### Graduate Research Assistant (Computer Science), 2005--2007
...
: OWL (Web Ontology Language), RDF Schema (RDFS), Description Logic,
  ...
  ([IKL](http://www.ihmc.us/users/phayes/IKL/SPEC/SPEC.html)),
...
Tools
:   Eclipse, Git (CLI, GitLab, GitHub), Emacs, LaTeX, MS Office
...
S. Bringsjord, A. Shilliday, J. Taylor.
[Slate](http://www.cogsci.rpi.edu/slate){.system}. System for Logic and
Theorem Extraction; a logic-based application for assisting reasoners in
the fields of Intelligence Analysis, Logic, Math, etc.
<http://www.cogsci.rpi.edu/slate/>. 2003--present.

S. Bringsjord, M. Clark, A. Shilliday, J. Taylor, D. Werner.
[Solomon](http://www.cogsci.rpi.edu/solomon){.system}. A Next-Generation
Q&A System. <http://www.cogsci.rpi.edu/solomon/>. 2006--present.
...
Evaluation](http://dx.doi.org/10.1145/2808475.2808476){.title}. In
...
> against cyber attack. Despite this, proactive defensive measures have
> not been widely deployed. This is because flexible proactive defensive
> measures such as Moving Target Defense (MTD) have as much potential to
> interfere with a network\'s ability to support the mission as they do
> to defend the network. In this paper we introduce an approach to
> defining and measuring MTD effects applied in a network environment to
> help guide MTD deployment decisions that successfully balance the
> potential security benefits of MTD deployment against the potential
> productivity costs.

N. S. Govindarajalulu, S. Bringsjord, J. Taylor, [Proof verification and
proof discovery for
...
J. Taylor, S. Bringsjord, M. Clark. [Getting Started with
Slate](http://www.cs.rpi.edu/~tayloj/DOCS/SlatePrimer_20100915.pdf){.title}.
September 2010. Available online from

> <http://www.cs.rpi.edu/~tayloj/DOCS/SlatePrimer_20100915.pdf>
...
Bringsjord, S.; Kellett, O.; Shilliday, A.; Taylor, J.; Van Heuveln, B.;
